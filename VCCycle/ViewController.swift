...
class ViewController: UIViewController {
    ...
    // view(메인뷰)를 만들어 내는 시점/지점 (한 번만 호출): 코드로 짤 때 뷰 교체 가능 시점
    // 스토리보드로 이용할 때, 호출하면 화면 로드 안 됨 ⭐️
//    override func viewDidLoad() {
//        super.loadView()          // 재정의해서, 구현할 때 상위호출 필요하지 않음(하면 안 됨)
//        print("VC-1 loadView 호출됨")
//    }
    
    // 스토리보드 뷰와 연결된 후 (한 번만 호출): 코드와 스토리보드의 뷰가 연결된 후
    override func viewDidLoad() {
        super.viewDidLoad()
